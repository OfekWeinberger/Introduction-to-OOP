 ...
 * the left bound (inclusive) of the sequence of sticks to mark,
 * and the right bound (inclusive) of the same sequence.
 */
public class Move {

	/**
	 *  represents the row of the move
	 */
	private int inRow;
	/**
	 *  represents the left most stick in the move
	 */
	private int inLeft;
	/**
	 *  represents the right most stick in the move
	 */
	private int inRight;
