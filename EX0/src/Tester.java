public class Tester {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(book1.getCurrentBorrowerId() == noPatron); //not borrowed
        book1.setBorrowerId(3);
        System.out.println(book1.getCurrentBorrowerId() == 3);
        book1.returnBook();
        System.out.println(book1.getCurrentBorrowerId() == noPatron); //was returned
        ...
        System.out.println("6: " + (book4Id1 == noPatron));
        System.out.println("7: " + (library1.getBookId(book2) == book2Id1));
        System.out.println("8: " + (library1.getBookId(book4) == noPatron));
        ...
        System.out.println("12: " + (library1.getPatronId(patron2) == noPatron)); //not registered
        ...
        System.out.println("15: " + (patron4Id1 == noPatron));
        ...
        System.out.println("18: " + (!library1.borrowBook(noPatron, patron1Id1))); //bookId is not valid
        System.out.println("19: " + (!library1.borrowBook(book1Id1, noPatron))); //patronId is not valid
        ...
        library1.returnBook(noPatron); //should not have any effect, bookId is not valid
        ...
        library1.borrowBook(noPatron, patron2Id1);
        ...
        System.out.println("31: " + (!(book4Id2 == book5Id2))); //same getData() but different objects
        System.out.println("32: " + (!(patron4Id2 == patron5Id2))); //same getData() but different objects
